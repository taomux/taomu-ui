import{C as i,L as n,D as d,c as $,n as t,l as o,T as e}from"./mini-scrollbar-BRbUwqmL.js";const c={common:{...i},light:{...n},dark:{...d}},s={};function f(r,l){Object.assign(c[r],l)}function m(){let r="";for(const l in s){const a=s[l];a.scoped?r+=`.${l}{${a.styled.styles}}`:r+=a.styled.styles}return $`
    :root {
      ${t(c.common,e)}
    }
