import{a as i}from"./mini-scrollbar-DKhO_gnw.js";import{R as p}from"./index-CZMpeKRu.js";import{R as t}from"./radio-group-Bi0wWH3-.js";import"./jsx-runtime-CLpGMVip.js";import"./use-taomu-classname-BRbG1Owv.js";import"./radio-DjDYUXWh.js";import"./global-vars-CuQyjSF-.js";const f={title:"Components/Radio/RadioGroup",component:t,tags:["autodocs"],argTypes:{}},a={args:{options:[{label:"Radio 1",value:"1"},{label:"Radio 2",value:"2"},{label:"Radio 3",value:"3"}]},render:n=>{const[s,l]=p.useState();return i(t,{...n,value:s,onChange:u=>l(u.target.value)})}};var e,o,r;a.parameters={...a.parameters,docs:{...(e=a.parameters)==null?void 0:e.docs,source:{originalSource:`{
  args: {
    options: [{
      label: 'Radio 1',
      value: '1'
