var ge=Object.defineProperty;var ve=(i,t,n)=>t in i?ge(i,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):i[t]=n;var y=(i,t,n)=>ve(i,typeof t!="symbol"?t+"":t,n);import{R as c}from"./index-l2PZgWEW.js";import{s as be,c as ye,l as Q,e as xe,j as Ce,Q as Z,a as w,X as Ee,N as G}from"./mini-scrollbar-BFxqz1iK.js";import{u as ee,a as Be,c as M}from"./use-taomu-classname-XwI4-eYN.js";import{r as Fe}from"./index-BtTJd_qj.js";import{T as J}from"./index-zbzXvoZu.js";import{p as x}from"./popup.store-GDxz-sH0.js";function L(i,t,n,u=[],s){const o=c.useRef(n);o.current=n,c.useEffect(()=>{if(!o.current)return;function r(l){var e;(e=o.current)==null||e.call(this,l)}return i.addEventListener(t,r,s),()=>{i.removeEventListener(t,r,s)}},u)}be("common",{zIndex:"1000",overlayBackground:"rgba(0, 0, 0, 0.4)"});const we=ye`
  position: fixed;
  left: 0;
  top: 0;
  width: 100vw;
...
}`},description:"动态动画类型处理函数",name:"popupAnimationConfigBuilder",required:!1,type:{name:"PopupAnimationConfigBuilder"}},onBeforeEnter:{defaultValue:null,description:"",name:"onBeforeEnter",required:!1,type:{name:"((el?: HTMLElement | null) => void)"}},onEnter:{defaultValue:null,description:"",name:"onEnter",required:!1,type:{name:"((el: HTMLElement) => void)"}},onBeforeLeave:{defaultValue:null,description:"",name:"onBeforeLeave",required:!1,type:{name:"((el: HTMLElement) => void)"}},onLeave:{defaultValue:null,description:"",name:"onLeave",required:!1,type:{name:"(() => void)"}},onBackgroundClickClose:{defaultValue:null,description:"",name:"onBackgroundClickClose",required:!1,type:{name:"(() => void)"}},onEscClose:{defaultValue:null,description:"",name:"onEscClose",required:!1,type:{name:"(() => void)"}}}}}catch{}class W{constructor(t,n={}){y(this,"popupId",Z(te));y(this,"popupRef",c.createRef());y(this,"createIndex",x.getState().popupsMap.size+1);y(this,"isEnter",!1);y(this,"render",t=>{const{portalContainer:n,createContainerId:u,createContainerClass:s,zIndex:o=1e3,onBeforeEnter:r,onBeforeLeave:l,onLeave:e,...m}=this.baseOptions,g=this.Content;return Fe.createPortal(w(N,{ref:this.popupRef,popupId:this.popupId,zIndex:o+this.createIndex,show:!0,onBeforeEnter:v=>(this.isEnter=!0,r==null?void 0:r(v)),onBeforeLeave:v=>(this.isEnter=!1,l==null?void 0:l(v)),onLeave:()=>(this.destroy(),e==null?void 0:e()),...m,children:w(g,{...t})},this.popupId),this.container,this.popupId)});y(this,"close",()=>{var t;this.popupRef.current&&((t=this.popupRef.current)==null||t.close())});y(this,"destroy",()=>{const{popupsMap:t,updateCount:n}=x.getState();t.delete(this.popupId),x.setState({popupsMap:t,updateCount:n+1})});y(this,"dispatchUpdate",(t,n)=>{const{popupsMap:u,updateCount:s}=x.getState();u.has(this.popupId)&&(n&&this.updateBaseOptionsStatic(n),u.set(this.popupId,[this,t]),x.setState({popupsMap:u,updateCount:s+1}))});this.Content=t,this.baseOptions=n}get containerId(){return this.baseOptions.createContainerId||"taomu-popup-container"}get container(){if(this.baseOptions.portalContainer)return this.baseOptions.portalContainer;const t=this.containerId,n=document.getElementById(t);if(n)return n;const u=document.createElement("div");return u.id=t,u.className=M("taomu-popup-container",this.baseOptions.createContainerClass),u.style.width="0",u.style.height="0",document.body.appendChild(u),u}get isOpened(){return!!this.popupRef.current}baseOpen(t){var s;const{popupsMap:n,updateCount:u}=x.getState();n.set(this.popupId,[this,t]),x.setState({popupsMap:n,updateCount:u+1}),this.isOpened&&((s=this.popupRef.current)==null||s.open())}}try{W.displayName="PopupPortalBase",W.__docgenInfo={description:"Popup 传送门",displayName:"PopupPortalBase",props:{}}}catch{}class Ie extends W{constructor(n,u={}){super(n,u);y(this,"open",(n,u)=>{u&&this.updateBaseOptionsStatic(u),this.baseOpen(n)});y(this,"updateBaseOptionsStatic",n=>{Object.assign(this.baseOptions,n)});this.Content=n,this.baseOptions=u}}const Y=c.forwardRef(({children:i,content:t,trigger:n="hover",position:u="bottom-left",portalOptions:s,debounceTime:o=150,contentProps:r={}},l)=>{var k;const e=c.useRef(),m=c.useRef(new Ee),g=c.useRef(!1),[v,b]=c.useState(null),P=ee("popup-trigger",v,(k=i.props)==null?void 0:k.className);c.useImperativeHandle(l,()=>({openPopup:A,closePopup:C,popupPortal:e.current})),c.useEffect(()=>()=>{var a;(a=e.current)==null||a.destroy()},[]),c.useEffect(()=>{if(t){const a={positionType:u,...s,clickToClose:n==="click"};if(n==="hover"){a.contentWrapperProps||(a.contentWrapperProps={});const p=a.contentWrapperProps.onMouseEnter,f=a.contentWrapperProps.onMouseLeave;a.contentWrapperProps.onMouseEnter=h=>{g.current=!0,p==null||p(h)},a.contentWrapperProps.onMouseLeave=h=>{g.current=!1,f==null||f(h),!(e.current&&h.relatedTarget&&G(h.relatedTarget,"."+e.current.popupId))&&C()}}e.current?e.current.dispatchUpdate(r,a):e.current=new Ie(t,a),b(e.current.popupId)}else e.current=void 0},[t,s,n,r]);function A(a){if(!e.current)return console.warn("PopupPortal instance not found");m.current.debounce(()=>{var p;(p=e==null?void 0:e.current)==null||p.open(r,{positionTargetElement:a,...s})},n==="hover"?o:0)}function C(){m.current.debounce(()=>{var a;n==="hover"&&g.current||(a=e.current)==null||a.close()},n==="hover"?o:0)}const F={className:P};return n==="click"?F.onClick=a=>{var p,f,h,B;if((f=(p=i.props)==null?void 0:p.onClick)==null||f.call(p,a),(h=e.current)!=null&&h.isEnter){C();return}else(B=e.current)!=null&&B.isOpened&&e.current.destroy();A(a.currentTarget||a.target)}:n==="hover"&&(F.onMouseEnter=a=>{var p,f,h,B;g.current=!0,(f=(p=i.props)==null?void 0:p.onMouseEnter)==null||f.call(p,a),!((h=e.current)!=null&&h.isEnter)&&((B=e.current)!=null&&B.isOpened&&e.current.destroy(),A(a.currentTarget||a.target))},F.onMouseLeave=a=>{var p,f;g.current=!1,(f=(p=i.props)==null?void 0:p.onMouseOut)==null||f.call(p,a),!(e.current&&a.relatedTarget&&G(a.relatedTarget,"."+e.current.popupId,e.current.containerId))&&C()}),c.cloneElement(i,{...i.props,...F})});try{Y.displayName="PopupTrigger",Y.__docgenInfo={description:"",displayName:"PopupTrigger",props:{children:{defaultValue:null,description:"触发元素",name:"children",required:!0,type:{name:"Element"}},content:{defaultValue:null,description:"弹出内容",name:"content",required:!1,type:{name:"ComponentType<any>"}},contentProps:{defaultValue:{value:"{}"},description:"弹出内容 props 用于更新弹层内部数据",name:"contentProps",required:!1,type:{name:"any"}},trigger:{defaultValue:{value:"hover"},description:"触发条件，默认: click",name:"trigger",required:!1,type:{name:"enum",value:[{value:'"none"'},{value:'"click"'},{value:'"hover"'}]}},position:{defaultValue:{value:"bottom-left"},description:"弹出位置, 默认为 'bottom-left'",name:"position",required:!1,type:{name:"enum",value:[{value:'"left"'},{value:'"center"'},{value:'"right"'},{value:'"bottom"'},{value:'"top"'},{value:'"left-left"'},{value:'"left-center"'},{value:'"left-right"'},{value:'"left-bottom"'},{value:'"left-top"'},{value:'"center-left"'},{value:'"center-center"'},{value:'"center-right"'},{value:'"center-bottom"'},{value:'"center-top"'},{value:'"right-left"'},{value:'"right-center"'},{value:'"right-right"'},{value:'"right-bottom"'},{value:'"right-top"'},{value:'"bottom-left"'},{value:'"bottom-center"'},{value:'"bottom-right"'},{value:'"bottom-bottom"'},{value:'"bottom-top"'},{value:'"top-left"'},{value:'"top-center"'},{value:'"top-right"'},{value:'"top-bottom"'},{value:'"top-top"'},{value:'"dialog-center"'}]}},portalOptions:{defaultValue:null,description:"传送门选项",name:"portalOptions",required:!1,type:{name:"PopupPortalOptions"}},debounceTime:{defaultValue:{value:"150"},description:"防抖时间, 只在 trigger 为 hover 时生效",name:"debounceTime",required:!1,type:{name:"number"}}}}}catch{}export{W as P,Y as a,Ie as b,N as c,Me as d};
