var ge=Object.defineProperty;var ve=(i,t,n)=>t in i?ge(i,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):i[t]=n;var y=(i,t,n)=>ve(i,typeof t!="symbol"?t+"":t,n);import{R as c}from"./index-DRjF_FHU.js";import{c as be,l as Q,g as ye,j as xe,Q as Z,a as w,X as Ce,N as G}from"./mini-scrollbar-mYdyJkLe.js";import{u as ee,a as Ee,c as M}from"./use-taomu-classname-CJDXS2sd.js";import{r as Be}from"./index-rX-Bn4lm.js";import{T as J}from"./index-BpBZeYWD.js";import{s as Fe}from"./global-style-BA4-Iv3r.js";import{p as x}from"./popup.store-Czhb4goW.js";function L(i,t,n,u=[],s){const o=c.useRef(n);o.current=n,c.useEffect(()=>{if(!o.current)return;function r(l){var e;(e=o.current)==null||e.call(this,l)}return i.addEventListener(t,r,s),()=>{i.removeEventListener(t,r,s)}},u)}Fe("common",{zIndex:"1000",overlayBackground:"rgba(0, 0, 0, 0.4)"});const we=be`
  position: fixed;
  left: 0;
  top: 0;
  width: 100vw;
