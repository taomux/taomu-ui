...
}`,...(Sn=(On=x.parameters)==null?void 0:On.docs)==null?void 0:Sn.source}}};const Vn=["基础示例","无头","无脚","按钮居中","无关闭icon","无外边框","无分割线","阴影","底部元素扩展","长标题","函数打开","事件穿透","异步关闭","内部定义回调","Hooks调用","无动画","超出屏幕滚动"];export{B as Hooks调用,Vn as __namedExportsOrder,Un as default,v as 事件穿透,w as 内部定义回调,k as 函数打开,c as 基础示例,f as 底部元素扩展,D as 异步关闭,u as 按钮居中,p as 无关闭icon,h as 无分割线,y as 无动画,m as 无外边框,d as 无头,g as 无脚,x as 超出屏幕滚动,T as 长标题,C as 阴影};
