var be=Object.defineProperty;var ye=(u,t,o)=>t in u?be(u,t,{enumerable:!0,configurable:!0,writable:!0,value:o}):u[t]=o;var b=(u,t,o)=>ye(u,typeof t!="symbol"?t+"":t,o);import{R as c}from"./index-CZMpeKRu.js";import{c as Ce,l as J,h as xe,j as Ee,e as ee,a as P,y as Be,i as Q}from"./mini-scrollbar-DKhO_gnw.js";import{u as te,a as Fe,c as N}from"./use-taomu-classname-BRbG1Owv.js";import{r as we}from"./index-C5atF7ks.js";import{T as Y}from"./index-CUnKnXLJ.js";import{i as Pe}from"./global-vars-CuQyjSF-.js";import{p as y}from"./popup.store-B3fQShZ5.js";function M(u,t,o,r=[],s){const n=c.useRef(o);n.current=o,c.useEffect(()=>{if(!n.current)return;function i(l){var e;(e=n.current)==null||e.call(this,l)}return u.addEventListener(t,i,s),()=>{u.removeEventListener(t,i,s)}},r)}Pe("common",{zIndex:"1000",overlayBackground:"rgba(0, 0, 0, 0.4)"});const Ae=Ce`
  position: fixed;
  left: 0;
  top: 0;
  width: 100vw;
