import{e as C,Y as i,Z as B,j as p,a as o,B as n,$ as b}from"./iframe-D6mQ9x1r.js";function g(e,{destroyOnUnmount:t=!0,...r}={}){const c=C.useRef(new i(e,r));return C.useEffect(()=>()=>{t&&c.current.destroy()},[]),c.current}const v={title:"Components/Popup",component:B,tags:["autodocs"],argTypes:{},parameters:{docs:{description:{component:`弹层核心
