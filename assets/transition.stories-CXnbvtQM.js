...
}`,...(f=(u=t.parameters)==null?void 0:u.docs)==null?void 0:f.source},description:{story:"`children.ref` 将在内部被更改，即使传入也不会生效，但 `Transition` 接收 `proxyRef` 代理 `children.ref`",...(w=(h=t.parameters)==null?void 0:h.docs)==null?void 0:w.description}}};var b,v,g;a.parameters={...a.parameters,docs:{...(b=a.parameters)==null?void 0:b.docs,source:{originalSource:`{
  render: () => {
    const [show, setShow] = React.useState(false);
    return <div>
        <div className="mb-12">
...
}`,...(g=(v=a.parameters)==null?void 0:v.docs)==null?void 0:g.source}}};const z=["基础示例","动态示例","自定义动画函数"];export{z as __namedExportsOrder,B as default,t as 动态示例,s as 基础示例,a as 自定义动画函数};
