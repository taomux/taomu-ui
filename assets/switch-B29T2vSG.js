import{l as t,m as l,c as O,p as W,a as f,f as A}from"./mini-scrollbar-DKhO_gnw.js";import{R as e}from"./index-CZMpeKRu.js";import{u as P,a as Y,c as j}from"./use-taomu-classname-BRbG1Owv.js";import"./index-b9g8Vhfs.js";import{i as w}from"./global-vars-CuQyjSF-.js";import{L as z}from"./loading-DUVmW9bg.js";w("common",{switchColor:t("colorPrimary"),switchWidth:34,switchHeight:18,switchRadius:t("radiusSM"),switchBorderColor:t("colorBorder"),switchOutlineColor:l("colorPrimaryRgb",.3),switchBoxBg:l("colorFrontRgb",.1),switchBoxBgActive:t("switchColor")});w("light",{switchDefaultColor:"#fff",switchBorderColor:"colorBorderSplit"});w("dark",{switchDefaultColor:l("colorFrontRgb",.6)});const E=O`
  --td: 0.25s;
  ...
  &.is-loading {
    cursor: progress;
    &:not(.active) {
      ${W("loadingColor",`color-mix(in srgb, ${t("switchColor")}, #fff 65%)`)};
    }
  }
