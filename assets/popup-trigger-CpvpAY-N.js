var xe=Object.defineProperty;var Be=(u,e,t)=>e in u?xe(u,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):u[e]=t;var g=(u,e,t)=>Be(u,typeof e!="symbol"?e+"":e,t);import{R as f}from"./index-D4lIrffr.js";import{l as Y,c as Ee,n as Fe,j as we,g as oe,a as P,y as Pe,o as Z}from"./mini-scrollbar-CPC470y1.js";import{u as ne,a as Ae,c as j}from"./use-taomu-classname-DBKvGVUz.js";import{r as Te}from"./index-BQQLSK9g.js";import{T as ee}from"./index-vYJU6RZc.js";import{i as Ie}from"./global-vars-CoVtkCb5.js";import{p as b}from"./popup.store-D6eLbj-g.js";function N(u,e,t,r=[],l){const o=f.useRef(t);o.current=t,f.useEffect(()=>{if(!o.current)return;function i(p){var n;(n=o.current)==null||n.call(this,p)}return u.addEventListener(e,i,l),()=>{u.removeEventListener(e,i,l)}},r)}Ie("common",{zIndex:"1000",overlayBackground:"rgba(0, 0, 0, 0.4)"});const Ve=Ee`
  position: fixed;
  left: 0;
  top: 0;
  width: 100vw;
