var xe=Object.defineProperty;var Be=(u,e,t)=>e in u?xe(u,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):u[e]=t;var g=(u,e,t)=>Be(u,typeof e!="symbol"?e+"":e,t);import{R as f}from"./index-D4lIrffr.js";import{l as Y,c as Ee,i as Fe,j as we,h as oe,a as P,y as Pe,n as Z}from"./mini-scrollbar-DFcjLXiE.js";import{u as ne,a as Ae,c as j}from"./use-taomu-classname-CPr58zXM.js";import{r as Te}from"./index-BQQLSK9g.js";import{T as ee}from"./index-BPX1WxqX.js";import{i as Ie}from"./global-vars-hpilZV8k.js";import{p as b}from"./popup.store-D-RoL1D3.js";function N(u,e,t,r=[],l){const o=f.useRef(t);o.current=t,f.useEffect(()=>{if(!o.current)return;function i(p){var n;(n=o.current)==null||n.call(this,p)}return u.addEventListener(e,i,l),()=>{u.removeEventListener(e,i,l)}},r)}Ie("common",{zIndex:"1000",overlayBackground:"rgba(0, 0, 0, 0.4)"});const Ve=Ee`
  position: fixed;
  left: 0;
  top: 0;
  width: 100vw;
