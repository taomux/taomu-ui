import{j as p,a as o}from"./mini-scrollbar-CovzJoiJ.js";import{R as C}from"./index-DRjF_FHU.js";import"./index-D95NPG_q.js";import"./index-Dvld9rH6.js";import{b as i,c as G,d as K}from"./popup-trigger-C3L69WIX.js";import{B as n}from"./button-rm53FtF1.js";import"./jsx-runtime-DR9Q75dM.js";import"./use-taomu-classname-DM2_Z24H.js";import"./index-rX-Bn4lm.js";import"./index-BpBZeYWD.js";import"./global-style-emPCDtl7.js";import"./popup.store-DsFx4roX.js";function X(e,{destroyOnUnmount:t=!0,...r}={}){const c=C.useRef(new i(e,r));return C.useEffect(()=>()=>{t&&c.current.destroy()},[]),c.current}const ct={title:"Components/Popup",component:G,tags:["autodocs"],argTypes:{},parameters:{docs:{description:{component:`弹层核心
...
}`,...(J=(I=h.parameters)==null?void 0:I.docs)==null?void 0:J.source}}};const it=["函数打开","UsePopup","绝对位置","相对位置","边缘偏移","锁定滚动条","无动画"];export{u as UsePopup,it as __namedExportsOrder,ct as default,l as 函数打开,h as 无动画,a as 相对位置,s as 绝对位置,d as 边缘偏移,m as 锁定滚动条};
