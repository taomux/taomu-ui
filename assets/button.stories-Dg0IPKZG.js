...
}`,...(tn=(en=u.parameters)==null?void 0:en.docs)==null?void 0:tn.source},description:{story:"如果 onClick 返回一个 Promise, 则自动添加 loading\n\n控制开关：`autoLoading`，默认为 `true`\n\n效果不错，不用担心动画性能，你的GPU参与了渲染",...(an=(rn=u.parameters)==null?void 0:rn.docs)==null?void 0:an.description}}};const fn=["基础示例","类型","禁用状态","Ghost","Glass","不显示外轮廓","Loading","居中测试","CssVars_深度自定义","AutoLoading"];export{u as AutoLoading,c as CssVars_深度自定义,o as Ghost,i as Glass,l as Loading,fn as __namedExportsOrder,hn as default,y as 不显示外轮廓,p as 基础示例,d as 居中测试,m as 禁用状态,g as 类型};
