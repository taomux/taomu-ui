import{R as e,e as s,a as l}from"./iframe-Ci2SqJ0Y.js";const d={title:"Components/Radio/RadioGroup",component:e,tags:["autodocs"],argTypes:{}},a={args:{options:[{label:"Radio 1",value:"1"},{label:"Radio 2",value:"2"},{label:"Radio 3",value:"3"}]},render:o=>{const[n,r]=s.useState();return l(e,{...o,value:n,onChange:t=>r(t.target.value)})}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  args: {
    options: [{
      label: 'Radio 1',
      value: '1'
