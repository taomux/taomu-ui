import{j as a,a as n,S}from"./mini-scrollbar-CZ8eNCm3.js";import{R as b}from"./index-CZMpeKRu.js";import"./index-LoP-yWzs.js";import"./index-BSeDDhhT.js";import{i as P}from"./index-DUw1hRN3.js";import"./index-D10OYK2E.js";import{D as l}from"./dialog-CuJfVslN.js";import{C as Nn}from"./checkbox-Bae1i7y3.js";import{D as s}from"./dialog.portal-DNSVncFT.js";import{B as o}from"./button-q8HGN2cW.js";import"./jsx-runtime-CLpGMVip.js";import"./checkbox-group-B_Z-dl1W.js";import"./use-taomu-classname-CGrN28Ws.js";import"./conversion-C3YVphii.js";import"./index-bPVxIqPX.js";import"./icon-DK4Ek3YN.js";import"./help-circle-CUIW5fQg.js";import"./x-circle-CdlKYc8_.js";import"./alert-triangle-DUSJc6lc.js";import"./index-DhsYTemN.js";import"./loading-eEEt9sJo.js";import"./global-vars-CQDXv0Fn.js";import"./index-BzWh1BKN.js";import"./popup-trigger-DzyMuDii.js";import"./index-2nx3i45w.js";import"./index-D-TIQtLp.js";import"./index-CUnKnXLJ.js";import"./popup.store-C2C6BHPT.js";import"./use-custom-event-BQUnmHFA.js";function N(e,{destroyOnUnmount:r=!0,...t}={},i){const c=b.useRef(new s(e,t,i));return b.useEffect(()=>()=>{r&&c.current.destroy()},[]),c.current}const le={title:"Components/Dialog",component:l,tags:["autodocs"],argTypes:{}},d={args:{title:"Title",children:"Content"}},g={args:{children:"Content"}},p={args:{children:"Content",footer:!1}},u={args:{title:"Title",children:"Content",footerAlign:"center"}},m={args:{title:"Title",children:"Content",showCloseIcon:!1}},h={args:{title:"Title",children:"Content",outerBorder:!1}},C={args:{title:"Title",children:"Content",splitBorder:!1}},f={args:{title:"Title",children:"Content"},render:e=>a("div",{className:"flex col gap-12",children:[n(l,{...e,shadow:!1,children:"无"}),n(l,{...e,shadow:"xs",children:"xs"}),n(l,{...e,shadow:"sm",children:"sm"}),n(l,{...e,children:"Default"}),n(l,{...e,shadow:"md",children:"md"}),n(l,{...e,shadow:"lg",children:"lg"}),n(l,{...e,shadow:"xl",children:"xl"})]})},T={args:{title:"Title",children:"Content",width:600,beforeFooterNodes:[n(Nn,{children:"checkbox"},"checkbox"),n("div",{className:"flex-1"},"full"),n(o,{type:"warning",glass:!0,children:"Btn Left"},"btn-left")],afterFooterNodes:[n(o,{type:"primary",glass:!0,children:"Btn Right"},"btn-right")]}},k={args:{title:"Title Title Title Title Title Title Title Title Title Title Title Title Title Title Title Title Title",children:"Content"}},v={render(){function e(){new s(()=>n("div",{children:"dialog content"}),{title:"Title",onClose:()=>{console.log("onClose")},onOk:()=>{console.log("onOk")},onCancel:()=>{console.log("onCancel")}}).open()}return n("div",{children:n(o,{onClick:e,children:"open一个"})})}},D={render(){function e(){new s(()=>n("div",{children:"dialog content"}),{title:"Title"},{overlay:!1,backgroundEvent:!0}).open()}return n("div",{children:n(o,{onClick:e,children:"open一个"})})}},B={render(){function e(){new s(()=>n("div",{children:"dialog content"}),{title:"Title",onClose:()=>{console.log("onClose")},onOk:async()=>{await S(1e3),console.log("onOk")},onCancel:async()=>{await S(1e3),console.log("onCancel")}}).open()}return n("div",{children:n(o,{onClick:e,children:"open一个"})})}},w={render(){async function e(){return new s(({dialogPortalInstance:t,defineOnOk:i,defineOnCancel:c})=>(b.useEffect(()=>{console.log(t)},[]),i(async()=>(await S(1e3),"ok result")),c(async()=>"cancel result"),n("div",{children:"dialog content"})),{title:"Title",children:"Content"},{clickToClose:!0}).open().then(t=>{console.log(t)}).catch(t=>{console.log(t)})}return n("div",{children:n(o,{onClick:e,children:"open一个"})})}},y={render(){const e=N(({dialogPortalInstance:t})=>a("div",{className:"flex col gap-12",children:["dialog content"," ",n(o,{onClick:()=>{t.close()},children:"内部关闭"}),n(o,{onClick:()=>P("toast message"),children:"toast"})]}),{title:"Title",onClose:()=>{console.log("onClose")},onOk:()=>{console.log("onOk")},onCancel:()=>{console.log("onCancel")}});function r(){e.open()}return a("div",{className:"flex row gap-12",children:[n(o,{onClick:r,children:"open一个"}),n(o,{onClick:()=>P("toast message"),children:"toast"})]})}},x={render(){const e=N(({dialogPortalInstance:t})=>a("div",{children:["dialog content"," ",n(o,{onClick:()=>{t.close()},children:"内部关闭"})]}),{title:"Title",onClose:()=>{console.log("onClose")},onOk:()=>{console.log("onOk")},onCancel:()=>{console.log("onCancel")}},{contentAnimationConfig:!1,overlayAnimationConfig:!1});function r(){e.open()}return n("div",{children:n(o,{onClick:r,children:"open一个"})})}},O={render(){const e=N(()=>n("div",{children:Array.from({length:100}).map((t,i)=>a("div",{children:["item ",i]},i))}),{title:"100 items",stickyFrame:!0});function r(){e.open()}return n("div",{children:n(o,{onClick:r,children:"open一个"})})}};var I,A,R;d.parameters={...d.parameters,docs:{...(I=d.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
    title: 'Title',
    children: 'Content'
  }
...
}`,...(nn=($=f.parameters)==null?void 0:$.docs)==null?void 0:nn.source}}};var en,on,tn;T.parameters={...T.parameters,docs:{...(en=T.parameters)==null?void 0:en.docs,source:{originalSource:`{
  args: {
    title: 'Title',
    children: 'Content',
    width: 600,
...
}`,...(tn=(on=T.parameters)==null?void 0:on.docs)==null?void 0:tn.source}}};var rn,ln,an;k.parameters={...k.parameters,docs:{...(rn=k.parameters)==null?void 0:rn.docs,source:{originalSource:`{
  args: {
    title: 'Title Title Title Title Title Title Title Title Title Title Title Title Title Title Title Title Title',
    children: 'Content'
  }
}`,...(an=(ln=k.parameters)==null?void 0:ln.docs)==null?void 0:an.source}}};var sn,cn,dn;v.parameters={...v.parameters,docs:{...(sn=v.parameters)==null?void 0:sn.docs,source:{originalSource:`{
  render() {
    function openDialog() {
...
}`,...(Cn=(hn=B.parameters)==null?void 0:hn.docs)==null?void 0:Cn.source}}};var fn,Tn,kn;w.parameters={...w.parameters,docs:{...(fn=w.parameters)==null?void 0:fn.docs,source:{originalSource:`{
  render() {
...
}`,...(kn=(Tn=w.parameters)==null?void 0:Tn.docs)==null?void 0:kn.source}}};var vn,Dn,Bn;y.parameters={...y.parameters,docs:{...(vn=y.parameters)==null?void 0:vn.docs,source:{originalSource:`{
  render() {
...
}`,...(bn=(Sn=O.parameters)==null?void 0:Sn.docs)==null?void 0:bn.source}}};const ie=["基础示例","无头","无脚","按钮居中","无关闭icon","无外边框","无分割线","阴影","底部元素扩展","长标题","函数打开","事件穿透","异步关闭","内部定义回调","Hooks调用","无动画","超出屏幕滚动"];export{y as Hooks调用,ie as __namedExportsOrder,le as default,D as 事件穿透,w as 内部定义回调,v as 函数打开,d as 基础示例,T as 底部元素扩展,B as 异步关闭,u as 按钮居中,m as 无关闭icon,C as 无分割线,x as 无动画,h as 无外边框,g as 无头,p as 无脚,O as 超出屏幕滚动,k as 长标题,f as 阴影};
