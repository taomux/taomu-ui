import{m as c,l as e,c as V,j as B,a as $}from"./mini-scrollbar-BOcaVSbM.js";import{R as a}from"./index-2yJIXLcc.js";import{u as q,a as E}from"./use-taomu-classname-DiLeWjur.js";import{i as s}from"./use-custom-event-BLRByl6k.js";s("common",{checkboxSize:13,checkboxColor:e("colorPrimary"),checkboxBorderColor:e("colorBorder"),checkboxRadius:e("radiusSM"),checkboxOutlineColor:c("colorPrimaryRgb",.3)});s("dark",{checkboxBoxBackground:c("colorFrontRgb",.1)});const S=V`
  --td: 0.24s;
...
`,i=a.forwardRef(({children:r,className:u,cssVars:d,style:b,label:p,size:h,color:m,radius:x,showOutline:k=!0,name:f,value:g,disabled:t,onChange:o,...y},C)=>{const l=a.useRef(null),v=q("checkbox","checkbox-label",{disabled:t,"show-outline":k},u),w=E({checkboxSize:h,checkboxColor:m,checkboxRadius:x,...d},b);a.useImperativeHandle(C,()=>l.current);function R(n){o==null||o(n,n.target.checked)}return B("label",{className:v,style:w,css:S,...y,children:[$("input",{ref:l,name:f,className:"checkbox-box",type:"checkbox",disabled:t,checked:g,onChange:R}),r||p]})});try{i.displayName="Checkbox",i.__docgenInfo={description:"",displayName:"Checkbox",props:{label:{defaultValue:null,description:"复选框的标签",name:"label",required:!1,type:{name:"ReactNode"}},size:{defaultValue:null,description:"复选框尺寸",name:"size",required:!1,type:{name:"string | number"}},color:{defaultValue:null,description:"复选框颜色",name:"color",required:!1,type:{name:"string"}},radius:{defaultValue:null,description:"圆角",name:"radius",required:!1,type:{name:"string | number"}},disabled:{defaultValue:null,description:"禁用状态",name:"disabled",required:!1,type:{name:"boolean"}},showOutline:{defaultValue:{value:"true"},description:"显示外轮廓",name:"showOutline",required:!1,type:{name:"boolean"}},name:{defaultValue:null,description:"",name:"name",required:!1,type:{name:"string"}},value:{defaultValue:null,description:"",name:"value",required:!1,type:{name:"boolean"}},onChange:{defaultValue:null,description:"",name:"onChange",required:!1,type:{name:"((e: ChangeEvent<HTMLInputElement>, value: boolean) => void)"}}}}}catch{}export{i as C};
