var be=Object.defineProperty;var ye=(u,t,o)=>t in u?be(u,t,{enumerable:!0,configurable:!0,writable:!0,value:o}):u[t]=o;var b=(u,t,o)=>ye(u,typeof t!="symbol"?t+"":t,o);import{R as c}from"./index-2yJIXLcc.js";import{l as J,c as Ce,i as xe,j as Ee,g as ee,a as P,y as Be,n as Q}from"./mini-scrollbar-BOcaVSbM.js";import{u as te,a as Fe,c as N}from"./use-taomu-classname-DiLeWjur.js";import{r as we}from"./index-D-es_Zdh.js";import{T as Y}from"./index-z_ISaXHk.js";import{i as Pe}from"./use-custom-event-BLRByl6k.js";import{p as y}from"./popup.store-F3KXIqw7.js";function M(u,t,o,r=[],s){const n=c.useRef(o);n.current=o,c.useEffect(()=>{if(!n.current)return;function i(l){var e;(e=n.current)==null||e.call(this,l)}return u.addEventListener(t,i,s),()=>{u.removeEventListener(t,i,s)}},r)}Pe("common",{zIndex:"1000",overlayBackground:"rgba(0, 0, 0, 0.4)"});const Ae=Ce`
  position: fixed;
  left: 0;
  top: 0;
  width: 100vw;
