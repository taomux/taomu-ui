import{j as p,a as o}from"./emotion-react-jsx-runtime.browser.esm-BmIFEm2U.js";import{R as C}from"./index-l2PZgWEW.js";import"./index-Ct6AoaM2.js";import"./index-B888oYOY.js";import{b as i,c as G,d as K}from"./popup-trigger-BnUp-N6y.js";import{B as n}from"./button-DXEHRL-y.js";import"./jsx-runtime-DWbWqHZ-.js";import"./mini-scrollbar-DUVypj3v.js";import"./use-taomu-classname-BHBGss1S.js";import"./index-6lph7OXq.js";import"./popup.store-CruYBn8Q.js";function X(e,{destroyOnUnmount:t=!0,...r}={}){const c=C.useRef(new i(e,r));return C.useEffect(()=>()=>{t&&c.current.destroy()},[]),c.current}const pt={title:"Components/Popup",component:G,tags:["autodocs"],argTypes:{},parameters:{docs:{description:{component:`弹层核心
...
}`,...(J=(I=h.parameters)==null?void 0:I.docs)==null?void 0:J.source}}};const ct=["函数打开","UsePopup","绝对位置","相对位置","边缘偏移","锁定滚动条","无动画"];export{u as UsePopup,ct as __namedExportsOrder,pt as default,l as 函数打开,h as 无动画,a as 相对位置,s as 绝对位置,d as 边缘偏移,m as 锁定滚动条};
